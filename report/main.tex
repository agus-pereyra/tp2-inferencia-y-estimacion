...
{\color{red}ACA VAN LOS GRAFICOS DE BARRA}

\begin{multicols}{2}


En los graficos se presentan las distribuciones de frecuencia de aparición de símbolos en tres archivos
de texto distinto: adn.txt, mitologia.txt y tabla.txt. {\color{red}SI ESTO LO PONEN EN METODOLOGIA AVISEN}
...
deberse a la estructura del lenguaje español. Asimismo, vemos como el caracter mas usado es el " " (espacio) lo que concuerda con la regla gramatical de separar las palabras con este simbolo. {\color{red}(Capaz puede decir algo mas)}
...
{\color{red}AHORA VA LA TABLA. ACA MEDIO QUE REPTTO LO MISMO. ARREGLAR DESPUES}
...
Finalmente, en tabla.txt vemos una disstribucion no uniforme dominada por numeros y signos de puntuacion. En este caso, el numero de simbolos unicos es similar al del texto de mitologia ({\color{red}PREGUNTAR A BOMBI SI LO TRUNCO}), sin embargo vemos que la longitud promedio de Huffman es menor siendo de 3.52 bits por simbolo y una reduccion de memoria del 41.40\%. Esto indica 
